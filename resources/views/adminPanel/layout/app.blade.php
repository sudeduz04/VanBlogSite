    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
              ...
              <span class="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">Van.com</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                <!-- Dashboard -->
                <li class="menu-item">
                    <a href="{{route('panel.categoryList')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Kategoriler</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{route('panel.contentList')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">İçerikler</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{route('front.show')}}" target="_blank" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
